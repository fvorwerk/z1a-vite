      ...
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            ...
            <p className="text-gray-400">{t("We are a passionate team dedicated to creating outstanding digital experiences.")}</p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              <li>{t("123 Web Street, Digital City")}</li>
        ...
        <div className="border-t border-gray-800 mt-10 pt-6 text-center text-gray-400">
          <p>&copy; {currentYear} {t("Your Company. All rights reserved.")} | <span className="text-xs">{t("Responsible according to § 18 Abs. 2 MStV: Your Name, Address")}</span></p>
        </div>
      </div>
    </footer>
  );
